...
public:
    ...
    RCJSoccerRobot(Robot* r) {
        ...
        wheel1_motor = robot->getMotor("wheel1");
        wheel2_motor = robot->getMotor("wheel2");
        wheel3_motor = robot->getMotor("wheel3");
        wheel4_motor = robot->getMotor("wheel4");

        wheel1_motor->setPosition(INFINITY);
        wheel2_motor->setPosition(INFINITY);
        wheel3_motor->setPosition(INFINITY);
        wheel4_motor->setPosition(INFINITY);
        wheel1_motor->setVelocity(0.0);
        wheel2_motor->setVelocity(0.0);
        wheel3_motor->setVelocity(0.0);
        wheel4_motor->setVelocity(0.0);
    }
